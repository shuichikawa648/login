...
<html lang="ja">
    ...
    <div class="mail">
      <div class="hissu">必須</div><label>メールアドレス</label><br>
        <input type="text"　class="formbox"size="40"name="mail" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"reqired>
        </div>
      <div class="password">      
 ...
 <script>
    function ConfirmPassword(confirm){
        ...
        if(input1 != input2){
            confirm.setCustValidity("パスワードが一致しません。");
        }else{
